...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/Pruebas_Symfony2/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_3af9892c9e7d35f2fea74accf044cda4222ae3c4f93076d2d77f5cc37ab6fbf4');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_3af9892c9e7d35f2fea74accf044cda4222ae3c4f93076d2d77f5cc37ab6fbf4');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_3af9892c9e7d35f2fea74accf044cda4222ae3c4f93076d2d77f5cc37ab6fbf4');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\xampp\\htdocs\\Pruebas_Symfony2\\src\\Acme\\QuestionBundle\\Entity')), 'Acme\\QuestionBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('AcmeQuestionBundle' => 'Acme\\QuestionBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2mongodb_default_3af9892c9e7d35f2fea74accf044cda4222ae3c4f93076d2d77f5cc37ab6fbf4');

        $c = new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\xampp\\htdocs\\Pruebas_Symfony2\\src\\Acme\\StoreBundle\\Document', 1 => 'C:\\xampp\\htdocs\\Pruebas_Symfony2\\src\\Acme\\QuestionBundle\\Document'));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($c, 'Acme\\StoreBundle\\Document');
        $d->addDriver($c, 'Acme\\QuestionBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('AcmeStoreBundle' => 'Acme\\StoreBundle\\Document', 'AcmeQuestionBundle' => 'Acme\\QuestionBundle\\Document'));
        $instance->setMetadataCacheImpl($b);
        $instance->setMetadataDriverImpl($d);
        $instance->setProxyDir('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/doctrine/odm/mongodb/Proxies');
        $instance->setProxyNamespace('MongoDBODMProxies');
        $instance->setAutoGenerateProxyClasses(false);
        $instance->setHydratorDir('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/doctrine/odm/mongodb/Hydrators');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/Pruebas_Symfony2/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/Pruebas_Symfony2/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/Pruebas_Symfony2/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/Pruebas_Symfony2/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/Pruebas_Symfony2/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\doctrine\\mongodb-odm-bundle\\Doctrine\\Bundle\\MongoDBBundle/Resources/views', 'DoctrineMongoDB');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\src\\Acme\\StoreBundle/Resources/views', 'AcmeStore');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\src\\Acme\\QuestionBundle/Resources/views', 'AcmeQuestion');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/Pruebas_Symfony2/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/Pruebas_Symfony2/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/logs',
            'kernel.bundles' => array(
                ...
                'AcmeQuestionBundle' => 'Acme\\QuestionBundle\\AcmeQuestionBundle',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\Pruebas_Symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/doctrine/orm/Proxies',
            ...
            'doctrine_mongodb.odm.proxy_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/doctrine/odm/mongodb/Proxies',
            'doctrine_mongodb.odm.auto_generate_proxy_classes' => false,
            'doctrine_mongodb.odm.hydrator_namespace' => 'Hydrators',
            'doctrine_mongodb.odm.hydrator_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/dev/doctrine/odm/mongodb/Hydrators',
