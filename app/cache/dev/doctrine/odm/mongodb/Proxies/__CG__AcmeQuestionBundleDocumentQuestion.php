...
namespace MongoDBODMProxies\__CG__\Acme\QuestionBundle\Document;
 ...
 */
class Question extends \Acme\QuestionBundle\Document\Question implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setQuestionDescription($questiondescription);
    }

    public function getQuestionDescription()
    {
        $this->__load();
        return parent::getQuestionDescription();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'questiondescription', 'answers');
    }
