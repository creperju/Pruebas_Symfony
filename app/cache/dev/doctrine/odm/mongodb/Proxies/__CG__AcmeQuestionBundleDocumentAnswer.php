 ...
 */
class Answer extends \Acme\QuestionBundle\Document\Answer implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setAnswerDescription($answerdescription);
    }

    public function getAnswerDescription()
    {
        $this->__load();
        return parent::getAnswerDescription();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'answerdescription', 'question');
    }
