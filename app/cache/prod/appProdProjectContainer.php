...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_b5f525b334028a11ea4d4f3253d996a852c13ed6f48f7fdd9a1f24d4c79791ae');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_b5f525b334028a11ea4d4f3253d996a852c13ed6f48f7fdd9a1f24d4c79791ae');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b5f525b334028a11ea4d4f3253d996a852c13ed6f48f7fdd9a1f24d4c79791ae');
        ...
        $d->setProxyDir('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2mongodb_default_b5f525b334028a11ea4d4f3253d996a852c13ed6f48f7fdd9a1f24d4c79791ae');
        ...
        $instance->setProxyDir('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/doctrine/odm/mongodb/Proxies');
        $instance->setProxyNamespace('MongoDBODMProxies');
        $instance->setAutoGenerateProxyClasses(false);
        $instance->setHydratorDir('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/doctrine/odm/mongodb/Hydrators');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/Pruebas_Symfony2/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/Pruebas_Symfony2/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod',
            ...
            'session.save_path' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/doctrine/orm/Proxies',
            ...
            'doctrine_mongodb.odm.proxy_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/doctrine/odm/mongodb/Proxies',
            'doctrine_mongodb.odm.auto_generate_proxy_classes' => false,
            'doctrine_mongodb.odm.hydrator_namespace' => 'Hydrators',
            'doctrine_mongodb.odm.hydrator_dir' => 'C:/xampp/htdocs/Pruebas_Symfony2/app/cache/prod/doctrine/odm/mongodb/Hydrators',
